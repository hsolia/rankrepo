...
public class GetParticipantsResponse {
    ...
    protected int total;
    @XmlElementRef(name = "recorderID", namespace = "http://portal.vidyo.com/user/v1_1", type = JAXBElement.class)
    protected JAXBElement<Integer> recorderID;
    @XmlElementRef(name = "recorderName", namespace = "http://portal.vidyo.com/user/v1_1", type = JAXBElement.class)
    protected JAXBElement<String> recorderName;
    @XmlElementRef(name = "paused", namespace = "http://portal.vidyo.com/user/v1_1", type = JAXBElement.class)
    protected JAXBElement<Boolean> paused;
    @XmlElementRef(name = "webcast", namespace = "http://portal.vidyo.com/user/v1_1", type = JAXBElement.class)
