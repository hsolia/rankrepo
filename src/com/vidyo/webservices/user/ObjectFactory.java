 ...
 * generated in the com.vidyo.webservices.user package. 
...
public class ObjectFactory {
    ...
    private final static QName _ExceptionException_QNAME = new QName("http://portal.vidyo.com/user/v1_1", "Exception");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.vidyo.webservices.user
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://portal.vidyo.com/user/v1_1", name = "Exception", scope = Exception.class)
