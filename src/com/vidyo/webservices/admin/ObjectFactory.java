 ...
 * generated in the com.vidyo.webservices.admin package. 
...
public class ObjectFactory {
    ...
    private final static QName _FaultFault_QNAME = new QName("http://portal.vidyo.com/admin/v1_1", "Fault");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.vidyo.webservices.admin
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://portal.vidyo.com/admin/v1_1", name = "Fault", scope = Fault.class)
    public JAXBElement<Object> createFaultFault(Object value) {
        return new JAXBElement<Object>(_FaultFault_QNAME, Object.class, Fault.class, value);
    }
