...
public class Filter {
    ...
    @XmlElementRef(name = "start", namespace = "http://portal.vidyo.com/admin/v1_1", type = JAXBElement.class)
    protected JAXBElement<Integer> start;
    @XmlElementRef(name = "limit", namespace = "http://portal.vidyo.com/admin/v1_1", type = JAXBElement.class)
    protected JAXBElement<Integer> limit;
    @XmlElementRef(name = "sortBy", namespace = "http://portal.vidyo.com/admin/v1_1", type = JAXBElement.class)
    protected JAXBElement<String> sortBy;
    @XmlElementRef(name = "dir", namespace = "http://portal.vidyo.com/admin/v1_1", type = JAXBElement.class)
    protected JAXBElement<SortDir> dir;
    @XmlElementRef(name = "query", namespace = "http://portal.vidyo.com/admin/v1_1", type = JAXBElement.class)
    ...
    public void setSortBy(JAXBElement<String> value) {
        this.sortBy = ((JAXBElement<String> ) value);
    }
    ...
    public void setDir(JAXBElement<SortDir> value) {
        this.dir = ((JAXBElement<SortDir> ) value);
    }
