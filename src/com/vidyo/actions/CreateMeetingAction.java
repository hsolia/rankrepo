...
@ManagedBean(name="createMeetingAction")
@ViewScoped
public class CreateMeetingAction extends BaseAction  {
	...
	public void exportInvite(){
		try{
			...
			newPubRoom.setDescription(this.meetingName);
			newPubRoom = meetingManager.createMeeting(newPubRoom, this.meetingOwner);
			String invitaionDesc = meetingManager.renderInvitationTemplate(newPubRoom, this.meetingOwner);
			...
			invitaion +="SUMMARY;LANGUAGE=en-us:"+newPubRoom.getDescription() +"\n";
			invitaion +="LOCATION:"+meetingManager.renderiOsLinkUrl(newPubRoom)+"\n";
